...
<p>Click and confirm that you want to create an account on Weatherglass. This link can only be used once.</p>
...
func SendEmailConfirmation(emailClient *sendgrid.Client, hostName string, user *models.User) (*rest.Response, error) {
	...
	message := mail.NewSingleEmail(
		mail.NewEmail("Weatherglass", "team@weatherglass.herokuapp.com"),
		"Verify your email",
